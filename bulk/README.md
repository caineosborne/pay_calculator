...
This is a separate Streamlit product. It does not change the calculator API or duplicate award logic: it turns dated CSV rows into the existing `POST /calculate` payload, once per employee and fortnight.
