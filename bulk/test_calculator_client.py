...
class BulkCalculatorClientTests(unittest.TestCase):
    ...
    def test_uses_each_employees_own_profile(self):
        ...
        profiles = {
            "Alex": {"pay_cycle_start_day": "Monday", "hourly_rate": 30, "award": "hospitality", "worker_type": "shift", "employment_type": "full_time"},
            "Jordan": {"pay_cycle_start_day": "Monday", "hourly_rate": 45, "award": "aged_care", "worker_type": "day", "employment_type": "casual"},
        }
